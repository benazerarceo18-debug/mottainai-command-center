...
const TIMELINE_END = new Date('2027-03-31');
...
const MILESTONES: Milestone[] = [
  ...
  { name: 'Pilot Store Build-out', start: new Date('2026-07-01'), end: new Date('2026-10-31'), status: 'upcoming' },
  { name: 'Soft Launch', start: new Date('2026-10-01'), end: new Date('2026-11-30'), status: 'upcoming' },
];
            ...
            return (
              <div key={m.name} className="flex items-center">
                ...
                <div className="flex-1 relative h-8 bg-bg rounded">
                  {/* Grid lines for quarter boundaries */}
                  {QUARTERS.map((q, i) =>
                    i > 0 ? (
                      <div
                        key={q.label}
