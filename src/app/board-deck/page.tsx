      ...
      <div className="flex-1 flex flex-col px-12 py-8 bg-white">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            <div className="text-2xl font-bold text-[#FB923C]">₱45B</div>
            <div className="text-sm text-gray-500 mt-1">Japanese food segment</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            <div className="text-2xl font-bold text-[#FB923C]">12% YoY</div>
            <div className="text-sm text-gray-500 mt-1">Market growth</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            <div className="text-2xl font-bold text-[#FB923C]">White Space</div>
            <div className="text-sm text-gray-500 mt-1">No value-segment authentic ramen player</div>
          </div>
        </div>
        <h3 className="text-lg font-semibold text-[#111827] mb-3">Competitive Landscape</h3>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="bg-[#FB923C]/10 font-semibold">
                <td className="px-4 py-3 text-[#111827]">Mottainai</td>
                <td className="px-4 py-3 text-[#111827]">QSR Ramen</td>
                <td className="px-4 py-3 text-[#111827]">₱250–450</td>
                <td className="px-4 py-3 text-[#111827]">Authentic value ramen — only player</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col px-12 py-8 bg-white">
        ...
        <h3 className="text-lg font-semibold text-[#111827] mb-4">Cost Structure</h3>
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col px-12 py-8 bg-white">
        ...
        <div className="grid grid-cols-2 gap-8 flex-1">
          <div>
            <h3 className="text-lg font-semibold text-[#111827] mb-4">Store Rollout (Base)</h3>
            <div className="flex items-end gap-3 h-48 mb-6">
              {rollout.map((r) => (
                <div key={r.year} className="flex-1 flex flex-col items-center">
                  <span className="text-xs font-bold text-[#111827] mb-1">{r.cumulative}</span>
                  <div
                    className="w-full bg-[#111827] rounded-t"
          ...
          <div>
            <h3 className="text-lg font-semibold text-[#111827] mb-4">Landlord Mix</h3>
              ...
              {landlordMix.map((l) => (
                <div key={l.name} className="flex items-center gap-4">
                  ...
                  <div className="flex-1 bg-gray-100 rounded-full h-6 overflow-hidden">
                    <div
                      className="h-full bg-[#111827] rounded-full flex items-center justify-end pr-2"
                      style={{ width: l.pct }}
                    >
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col px-12 py-8 bg-white">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {scenarios.map((s) => (
                <tr
                  key={s.name}
                  className={s.highlight ? 'bg-[#FB923C]/10 font-semibold' : 'bg-white'}
                >
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 text-center">
            <div className="text-2xl font-bold text-[#111827]">Q1 2030</div>
                ...
                <div key={i} className="flex items-start gap-6 relative">
                  ...
                  <div className="flex-1 flex items-center justify-between bg-gray-50 rounded-lg px-6 py-4 border border-gray-200">
                    <div>
                      ...
                      <p className="text-base text-[#111827] font-medium mt-0.5">{m.item}</p>
                    </div>
            ...
            <tbody>
              {risks.map((r, i) => (
                <tr key={i} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  ...
                  <td className="px-4 py-4 font-medium text-[#111827]">{r.risk}</td>
...
function Slide9() {
  const useFunds = [
    { label: 'Build-out', pct: 60, color: 'bg-[#111827]' },
    { label: 'Working Capital', pct: 20, color: 'bg-[#FB923C]' },
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col px-12 py-8 bg-white">
        ...
        <div className="grid grid-cols-2 gap-8 flex-1">
          ...
          <div>
            <h3 className="text-lg font-semibold text-[#111827] mb-4">Use of Funds</h3>
            {/* Stacked bar */}
            ...
            <div className="space-y-3">
              {useFunds.map((u) => (
                <div key={u.label} className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold text-[#111827] ml-auto">{u.pct}%</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 max-w-2xl w-full mb-10">
          {links.map((l) => (
            <div key={l} className="bg-gray-50 rounded-lg px-6 py-4 border border-gray-200 flex items-center gap-3">
              <svg className="w-5 h-5 text-[#FB923C] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span className="text-sm text-[#111827] font-medium">{l}</span>
            </div>
          ))}
        </div>
          ...
          {slides.map((S, i) => (
            <button
              ...
              className={`aspect-video bg-white rounded-lg overflow-hidden border-2 transition-all hover:scale-105 ${
                i === current ? 'border-[#FB923C] ring-2 ring-[#FB923C]/50' : 'border-transparent'
              }`}
            >
